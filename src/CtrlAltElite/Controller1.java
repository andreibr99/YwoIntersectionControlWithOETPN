...
public class Controller1 {
	...
	public static void main(String[] args) {
		...
		grdiniT.Activations.add(new Activation(iniT, "ini", TransitionOperation.SendOverNetwork, "OP26"));
		...
		Condition T2Ct1_2 = new Condition(t2, "in1", TransitionCondition.NotNull);
		...
		grdT3.Activations.add(new Activation(t3, "green", TransitionOperation.SendOverNetwork, "OP3"));
		...
		grdT4.Activations.add(new Activation(t4, "yellow", TransitionOperation.SendOverNetwork, "OP3"));
		grdT4.Activations.add(new Activation(t4, "counter2", TransitionOperation.Move, "counter2"));
		
		t4.GuardMappingList.add(grdT4);
		
		Condition T4Ct1_2 = new Condition(t4, "in2", TransitionCondition.NotNull);
		...
		grdT4_3.Activations.add(new Activation(t4, "yellow", TransitionOperation.SendOverNetwork, "OP3"));
		...
		grdT5.Activations.add(new Activation(t5, "red", TransitionOperation.SendOverNetwork, "OP3"));
		grdT5.Activations.add(new Activation(t5, "green", TransitionOperation.SendOverNetwork, "OP5"));
		...
		grdT6.Activations.add(new Activation(t6, "yellow", TransitionOperation.SendOverNetwork, "OP5"));
		grdT6.Activations.add(new Activation(t6, "counter3", TransitionOperation.Move, "counter3"));
		
		t6.GuardMappingList.add(grdT6);
		
		Condition T6Ct1_2 = new Condition(t6, "in3", TransitionCondition.NotNull);
		...
		grdT6_3.Activations.add(new Activation(t6, "yellow", TransitionOperation.SendOverNetwork, "OP5"));
		...
		grdT7.Activations.add(new Activation(t7, "red", TransitionOperation.SendOverNetwork, "OP5"));
		grdT7.Activations.add(new Activation(t7, "green", TransitionOperation.SendOverNetwork, "OP26"));
		...
		grdT8.Activations.add(new Activation(t8, "yellow", TransitionOperation.SendOverNetwork, "OP26"));
		grdT8.Activations.add(new Activation(t8, "counter4", TransitionOperation.Move, "counter4"));
		
		t8.GuardMappingList.add(grdT8);
		
		Condition T8Ct1_2 = new Condition(t8, "in4", TransitionCondition.NotNull);
		...
		grdT8_3.Activations.add(new Activation(t8, "yellow", TransitionOperation.SendOverNetwork, "OP26"));
		...
		grdT9.Activations.add(new Activation(t9, "red", TransitionOperation.SendOverNetwork, "OP26"));
